<template>
  <div class="sm:px-24 py-12 px-10 bg-red-50 bg-opacity-90 overflow-x-hidden h-screen">
    <div class="flex flex-col">
      <div class="flex flex-row sm:justify-start justify-center py-1">
        <img
          class="sm:w-48 w-64 object-center"
      ...
      <footer class="sm:mt-12 mt-8">
        <div class="flex sm:flex-row flex-col sm:justify-between items-center sm:gap-y-0 gap-y-4">
          <p class="font-extralight text-sm sm:order-none order-1">© 2022 AjibsBaba - MIT License</p>
          <div class="flex flex-row gap-x-3">
            <a href="https://www.twitter.com/ajibs_baba" target="_blank">
              <svg class="w-5 h-5 hover:fill-acered" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
            ...
            <a href="https://www.github.com/AjibsBaba" target="_blank">
            ...
            <a href="https://www.ajibsbaba.com" target="_blank">
