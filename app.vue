  ...
  <div class="sm:px-24 py-12 px-10 bg-red-50 bg-opacity-90 overflow-x-hidden h-screen">
    <div class="flex flex-col">
      <div class="flex flex-row sm:justify-start justify-center py-1">
        <img
          class="sm:w-48 w-40 object-center"
      ...
      <div class="flex flex-row justify-between sm:py-24 py-20">
        <div class="flex flex-col">
          <h3 class="sm:text-8xl text-4xl sm:text-left text-center font-light">
        ...
        <div class="flex sm:flex-row flex-col sm:justify-between items-center sm:gap-y-0 gap-y-2">
          ...
          <div class="flex flex-row gap-x-2">
            <a href="https://www.twitter.com/ajibs_baba" target="_blank">
              <svg class="w-4 h-4 hover:fill-acered" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
